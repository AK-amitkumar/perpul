...
class ProductCategory(models.Model):
    ...
    def create_product_category(self, data, parent=False):
        """Create product category object in flectra
        ...
        for category in categories:
            if 'ParentRef' in category:
                ...
                # If Income or expense account present then map them with flectra Income or expense account
...
class Product(models.Model):
    ...
    def export_product_to_qbo(self):
        for product_id in self:
            ...
            if product_id.type == "product":
                ...
                # Get quickbooks id of inventory asset COA from flectra
    ...
    def create_product(self, data, parent=False):
        """Create product object in flectra
