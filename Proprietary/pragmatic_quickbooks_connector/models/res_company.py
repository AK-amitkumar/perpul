                    ...
                    if parsed_data.get('QueryResponse') and parsed_data.get('QueryResponse').get('Term'):
                        for term in parsed_data.get('QueryResponse').get('Term'):
                            ...
                            if recs:
                                ...
                                #     def createFlectraParentId(self, quickbook_id):
...
#                     print cust.get('Id'),"\n ------------------------------------------------"
#                     ''' Check if the Id from Quickbook is present in flectra or not if present
...
#                         if cust.get('Title'):
#                             ''' If Title is present then first check in flectra if title exists or not
...
#                                     in flectra to get countryId, stateId and create
#                                     state if not exists in flectra
#                                     ''' 
#                                 dict = {}
#                                 ''' 
...
#                                     result = self.createFlectraParentId(cust.get('ParentRef').get('value'))
#                                     if result:
