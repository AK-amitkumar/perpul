    ...
    def import_items(self):
        ...
        for record in self:
            ...
            if mapping_id:
                ...
                sync_vals['flectra_id'] = mapping_id.flectra_partner_id
...
class OrderFeed(models.Model):
    ...
    def import_order(self,channel_id):
        ...
        if state=='done' and currency:
            ...
            if not currency_id:
                message += '<br/> Currency %s no active in Perpul'%(currency)
                state = 'error'
        ...
        if match and match.order_name:
            if  state =='done' :
                try:
                    ...
                    message += self.env['multi.channel.skeleton']._SetFlectraOrderState(match.order_name, channel_id,
            ...
            if state == 'done':
                try:
                    ...
                    message += self.env['multi.channel.skeleton']._SetFlectraOrderState(erp_id, channel_id,  order_state, self.payment_method,date_invoice=date_invoice)
    ...
    def import_items(self):
        ...
        for record in self:
            ...
            if mapping_id:
                ...
                sync_vals['flectra_id'] = mapping_id.flectra_order_id
            sync_vals['summary'] = msz
