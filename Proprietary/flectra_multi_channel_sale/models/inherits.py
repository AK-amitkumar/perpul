    ...
    def get_category_list(self):
        ...
        if category_ids_list:
            for i in category_ids_list:
                li.append(i.flectra_category_id)
        return li
    ...
    def get_product_attribute_id(self, attribute_id):
        ...
        if not attribute_mapping:
            ...
            vals = {
                ...
                'flectra_attribute_id': product_attribute_id,
                'channel_id': context.get('channel_id'),
            ...
            product_attribute_id = attribute_mapping.flectra_attribute_id
    ...
    def get_product_attribute_value_id(self, attribute_id, product_attribute_id, template_id):
        ...
        if not attribute_value_mapping:
            ...
            map_env.create({
                ...
                'flectra_attribute_value_id': product_attribute_value_id,
                'channel_id': context.get('channel_id'),
                'ecom_store': context.get('channel')
            })
        else:
            product_attribute_value_id = attribute_value_mapping.flectra_attribute_value_id
...
class DeliveryCarrier(models.Model):
    ...
    channel_mapping_ids = fields.One2many(
        ...
        inverse_name='flectra_shipping_carrier',
        copy=False
    )
...
class ProductAttribute(models.Model):
    ...
    def create(self, vals):
        ...
        if context.get('flectra_multi_attribute') or context.get('install_mode'):
