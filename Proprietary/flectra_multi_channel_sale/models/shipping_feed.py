...
from flectra.addons.flectra_multi_channel_sale.tools import extract_list as EL
import logging
...
class ShippingFeed(models.Model):
    ...
    def create_shipping_mapping(self, channel_id, carrier_id, vals):
        vals = dict(
            ...
            flectra_carrier_id=carrier_id,
            flectra_shipping_carrier=carrier_id,
    ...
    def import_items(self):
        ...
        for record in self:
            ...
            if mapping_id:
                ...
                sync_vals['flectra_id'] = mapping_id.flectra_shipping_carrier
