...
from flectra.addons.web_settings_dashboard.controllers.main import WebSettingsDashboard as WSD
from flectra.addons.web.controllers.main import ensure_db, Session, Home
