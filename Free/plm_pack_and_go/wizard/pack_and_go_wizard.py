    ...
    def getAllAvailableTypes(self):
        ...
        try:
            ...
            if serverAddress is None:
                ...
                serverAddress = 'no_host_in_flectra_parameter"plm_convetion_server"!'
            fileExtensionsRes = requests.get('http://' + serverAddress + '/flectraplm/api/v1.0/getAvailableExtention')
