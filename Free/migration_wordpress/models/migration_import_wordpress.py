...
class MigrationImportWordpress(models.Model):
    ...
    def transform_post_content(self, content, media_json_data):
        """ Changes Wordpress content of any post type(page, blog, custom) to better fit in with the Perpul CMS, includes localising hyperlinks and media """
        ...
        if len(image_tags) != 0:
            for image_tag in image_tags:
                ...
                #Reimplement image resposiveness the Perpul way
