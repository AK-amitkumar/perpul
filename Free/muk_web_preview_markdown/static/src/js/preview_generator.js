...
flectra.define('muk_preview_markdown.PreviewGenerator', function (require) {
"use strict";

var core = require('web.core');

var PreviewGenerator = require('muk_preview.PreviewGenerator');
var PreviewHandler = require('muk_preview_markdown.PreviewHandler');
...
PreviewGenerator.include({
	...
	init: function(widget, additional_handler) {
		...
		this.handler = _.extend(this.handler, {
			"MarkdownHandler": new PreviewHandler.MarkdownHandler(widget)
		});
	},
});
