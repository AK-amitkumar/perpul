    ...
    def set_values(self):
        ...
        for record in self.browse(self.ids):
            config_parameters.set_param (
                'flectra_cenit.shipstation.key', record.key or ''
            )

        for record in self.browse(self.ids):
            config_parameters.set_param (
                'flectra_cenit.shipstation.secret', record.secret or ''
            )

        for record in self.browse(self.ids):
            config_parameters.set_param (
                'flectra_cenit.shipstation.store_id', record.store_id or ''
            )
