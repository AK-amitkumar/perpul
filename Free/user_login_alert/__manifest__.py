...
##############################################################################
{
    ...
    'summary': """Secure your Perpul account by alerts at right time. If any successful login to your
                account happens, an alert mail will be send to you with the browser and IP details.""",
    'version': '11.0.1.0.0',
    'description': """Secure your Perpul account by alerts at right time. If any successful login to your
                    account happens, an alert mail will be send to you with the browser and IP details.""",
