...
<RecepcionEnvio>
    ...
    def do_create_inv(self):
        ...
        try:
            ...
            if not inv:
                raise UserError('El archivo XML no contiene documentos para alguna empresa registrada en Perpul, o ya ha sido procesado anteriormente ')
        except Exception as e:
            _logger.warning('Error en 1 factura con error:  %s' % str(e))
