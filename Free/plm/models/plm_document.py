...
#   Overridden methods for this entity
    ...
    def canBeSavedClient(self, documentValues={}, returnCode=False):
        ...
        if returnCode:
            return True, _('Document %r with revision %r not present in Perpul.') % (docName, docRev), 'NO_ERROR'
        return True, _('Document %r with revision %r not present in Perpul.') % (docName, docRev)
