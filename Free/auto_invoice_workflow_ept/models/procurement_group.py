...
from flectra.addons.auto_invoice_workflow_ept.models.environment import uninstall_url
from flectra.addons.auto_invoice_workflow_ept.models.environment import registration_url
from flectra.addons.auto_invoice_workflow_ept.models.environment import success_url
...
class verify_key(models.TransientModel):
    ...
    def verify_key(self):
        ...
        from flectra.addons.auto_invoice_workflow_ept.models.environment import registration_url
        from flectra.addons.auto_invoice_workflow_ept.models.environment import success_url
        from flectra.addons.auto_invoice_workflow_ept.models.environment import erp_success_url
        from flectra.addons.auto_invoice_workflow_ept.models.environment import erp_registration_url
        from flectra.addons.auto_invoice_workflow_ept.models.environment import erp_uninstall_url
        ...
        if response and response.status_code == 200:
            ...
            if app_to_install:
                ...
                if app_to_install.state not in ['installed']:
                    skip = app_to_install.button_immediate_install()
