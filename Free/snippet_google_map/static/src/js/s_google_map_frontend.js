flectra.define('snippet_google_map.s_google_map_frontend', function (require) {
    'use strict';
        ...
        start: function () {
            ...
            if (typeof google !== 'object' || typeof google.maps !== 'object') {
                if (!sAnimation.registry.s_google_map.isScriptLoading) {
                    ...
                    window.flectra_snippet_google_map_redraw_all = function flectra_snippet_google_map_redraw_all() {
                    ...
                    defs.push(this._rpc({
                        ...
                        $('head').append($('<script/>', {
                            ...
                            src: "https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=flectra_snippet_google_map_redraw_all" + key_param,
                        }));
                    }));
                }
            } else {
