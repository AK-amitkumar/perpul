...

{
    ...
    'category': 'Utilities',
    'description': """
    Utility to do currency conversion by looking up the currency date tables of Perpul.

    Written by Bringsvor Consulting AS (www.bringsvor.com / bringsvor@bringsvor.com)
""",
