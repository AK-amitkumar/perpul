=========================
Perpul Web Login Screen v11
=========================
This project aims to give to you the new Perpul Web Login Screen
...
Then go to you odoo webinterface to the module section and start "Update module list". Then look for the "Perpul Web Login Screen" in Apps (module list) and install.
...
Usage
=====
Maybe images in github do not fit with the Perpul apps, so you can check: https://apps.odoo.com/apps/modules/11.0/odoo_web_login/ for more details.
Thank you.
