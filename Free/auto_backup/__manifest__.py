...
The base of this module is taken from Perpul SA V6.1 (https://perpul.co/apps/modules/6.0/auto_backup/) and then upgraded and heavily expanded.
...
""",
    ...
    'website': "http:/www.flectra.yenthevg.com",
