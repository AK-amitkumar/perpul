...

{
    ...
    'description': """
The app aims to add accessories and alternatives to products.
Perpul standard package let such functionality but only with E-shop installed.
* Manage accessories and alternatives through the smart buttons. Comfortable and clear. Counters in real time
* The app is anyway compatible with 'website_sale'. It means that if you installed the latter,
 the data would be kept saved and may be used in E-shop
""",
    'auto_install': False,
    'author': 'IT Libertas',
