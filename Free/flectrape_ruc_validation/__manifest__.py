...
#    Copyright (C) 2009-TODAY Perpul Peru(<http://www.flectraperu.pe>).
#    
...

{
    ...
    'license': 'AGPL-3',
    'contributors': [
        'Leonidas Pezo <leonidas@flectraperu.pe>',
    ],
    'description' : """
Validador RUC y DNI
-----------------------
...
Este módulo esta basado en el módulo de Alex Cuellar en https://github.com/alexcuellar/l10n_pe_doc_validation
    ...
    """,
    'website': 'http://flectraperu.pe/page/contabilidad',
    'depends' : ['account','flectrape_einvoice_base','flectrape_toponyms'],
    'data': [
