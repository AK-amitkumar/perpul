...
class product_template( models.Model ):
    ...
    website_message_ids = fields.One2many( 'mail.message', 'res_id', domain=lambda self: [( 'model', '=', self._name ), ( 'message_type', '=', 'comment' ), ( 'website_message', '=', True )], string='Website Comments' )
