...
def wkflectra_get_product_package(line_info,packaging_info):
    result=[]
...
def wkflectra_merge_half_package(items,max_qty=10):
...
if __name__=='__main__':
    ...
    for line_info in lines:
        res_package.extend(wkflectra_get_product_package(line_info,packaging_info))
    pprint.pprint(res_package)
    pprint.pprint(wkflectra_merge_half_package(res_package))
